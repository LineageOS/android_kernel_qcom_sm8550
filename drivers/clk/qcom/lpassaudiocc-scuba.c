...
static void lpass_audio_cc_scuba_sync_state(struct device *dev)
{
	qcom_cc_sync_state(dev, &lpass_audio_cc_scuba_desc);
}
...
static struct platform_driver lpass_audio_cc_scuba_driver = {
	...
	.driver = {
		...
		.sync_state = lpass_audio_cc_scuba_sync_state,
	},
};
